...
%%Jacobian
J_b1(i,:)=data(b1_idx,34)';
J_b2(i,:)=data(b2_idx,34)';
J_b3(i,:)=data(b3_idx,34)';

J_b1_med(i)=median(J_b1(i,:));
J_b1_Q1(i) = median(J_b1(i,find(J_b1(i,:)<median(J_b1(i,:)))));
J_b1_Q3(i) = median(J_b1(i,find(J_b1(i,:)>median(J_b1(i,:)))));   
