...
out_base='/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/figures/lung_sims/W_';

%home
%base='/home/loztop/mount_point/mount_point/plot_data/';
%out_base='/home/loztop/Dropbox/Dphil/poroelasticity_papers/coupling_paper/figures/lung_sims/W_';
...
hFig=figure;
set(hFig, 'Position', [100 100 570 430])
set([gca]             , ...
    'FontSize'   , 12           );
...
hLegend = legend( ...
  ...
  'location',[0.32,0.32,0.2,0.3],'interpreter','latex' );
