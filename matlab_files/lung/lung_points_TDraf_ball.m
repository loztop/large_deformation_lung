...
%work
base='/users/lorenzb/mount_point2/plot_data/';
...
XAXIS=[730,730*0.5,730*0.25,730*0.1];
...
'FontSize'   , fontF           );
  ...
  xlabel('Young''s modulus $(\mbox{Pa})$','interpreter','latex','FontSize',yaxisF)
 %set(gca,'XTick', 4:1:8);
  set(gca,'YTick', 1:0.2:2.4);
   ylim([0.95 2.4]);
axis square
output_plot_filename='j_C_ball'
out_base='/users/lorenzb/Dphil/poroelasticity_papers/coupling-nmbe/figures/';
...
'FontSize'   , fontF           );
  ...
  xlabel('Young''s modulus $(\mbox{Pa})$','interpreter','latex','FontSize',yaxisF)
 %set(gca,'XTick', 4:1:8);
  set(gca,'YTick', -125:25:0);
   ylim([-140 10]);
axis square
output_plot_filename='p_C_ball'
out_base='/users/lorenzb/Dphil/poroelasticity_papers/coupling-nmbe/figures/';
print(hFig,strcat(out_base,output_plot_filename),'-dpdf','-r0')
...
'FontSize'   , fontF           );
 ...
 %set(gca,'XTick', 4:1:8);
  set(gca,'YTick', 500:500:2000);
   ylim([400 2200]);
axis square
output_plot_filename='sige_C_ball'
out_base='/users/lorenzb/Dphil/poroelasticity_papers/coupling-nmbe/figures/';
print(hFig,strcat(out_base,output_plot_filename),'-dpdf','-r0')
